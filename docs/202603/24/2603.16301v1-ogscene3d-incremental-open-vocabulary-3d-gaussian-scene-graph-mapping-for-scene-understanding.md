...
tldr: OGScene3D 针对机器人增量探索环境的需求，提出了一种基于 3D 高斯泼溅的增量式开放词汇场景图构建系统。该系统通过置信度感知的语义表示和层次化优化策略，实现了全局一致的语义映射。结合长期全局优化和渐进式图构建，OGScene3D 能够动态更新场景节点及关系，在开放词汇场景理解任务中表现优异，为机器人提供了高效的 3D 场景理解能力。
selection_source: fresh_fetch
motivation: 现有开放词汇场景理解方法通常依赖预先构建的完整地图，难以适应机器人增量探索未知环境的实时需求。
method: 采用置信度感知的 3D 高斯语义表示，结合层次化语义优化、长期全局优化及渐进式图构建技术，实现动态语义映射与场景图生成。
result: 在主流数据集和真实场景中的实验证明，该方法在开放词汇语义映射和场景图构建的准确性与一致性上均优于现有技术。
conclusion: OGScene3D 成功实现了高效的增量式 3D 场景理解，为机器人在复杂环境下的导航与操作任务提供了强有力的支持。
---
