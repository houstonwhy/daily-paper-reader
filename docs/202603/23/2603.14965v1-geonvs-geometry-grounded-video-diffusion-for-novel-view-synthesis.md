...
method: 提出 GS-Adapter 模块，将扩散特征映射到 3D 高斯空间进行几何约束渲染，并以特征级融合纠正不一致的表示。
result: "在多项实验中，GeoNVS 相比 SEVA 和 CameraCtrl 性能提升了 11.3% 至 14.9%，且大幅降低了平移误差和倒角距离。"
