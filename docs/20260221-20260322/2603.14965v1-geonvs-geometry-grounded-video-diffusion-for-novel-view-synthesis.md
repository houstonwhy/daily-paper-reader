...
method: 提出 GS-Adapter，将扩散特征映射到 3D 高斯空间进行几何约束渲染，并以特征级融合的方式修正不一致的表示。
result: "在 9 个场景和 18 种设置下，GeoNVS 相比 SEVA 和 CameraCtrl 性能提升超过 11%，且大幅降低了平移误差和倒角距离。"
conclusion: GeoNVS 通过显式 3D 几何引导增强了视频扩散模型的几何一致性，为高质量、高可控的新视角合成提供了有效方案。
---
