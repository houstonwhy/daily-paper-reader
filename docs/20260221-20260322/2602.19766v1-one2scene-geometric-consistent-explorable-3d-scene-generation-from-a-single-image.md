...
tldr: One2Scene 针对单图生成可探索 3D 场景中的几何畸变问题，提出了一种将任务分解为全景图生成、3D 几何支架构建和新视角生成的框架。通过将全景图投影为多视角锚点并利用高斯泼溅网络构建几何支架，结合双向特征融合确保一致性，实现了在大范围相机移动下仍能保持几何准确且高保真的 3D 场景探索。
