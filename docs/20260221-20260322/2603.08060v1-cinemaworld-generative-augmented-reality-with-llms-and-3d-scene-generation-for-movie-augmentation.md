...
## 摘要
我们介绍了 CinemaWorld，这是一种生成式增强现实系统，它利用从 2D 电影场景中提取并与之同步的自动生成混合现实 3D 内容，来增强观众的物理环境。我们的系统使用多模态大语言模型（LLMs）对电影进行预处理以提取关键特征，利用生成式人工智能（Generative AI）生成动态 3D 增强内容，并将其空间化地嵌入到 Meta Quest 3 上的观众物理环境中。为了探索 CinemaWorld 的设计空间，我们对 8 名电影专业的学生进行了一项启发式研究，从而确定了几种关键的增强类型，包括粒子效果、周围物体、纹理叠加、角色驱动增强以及光影效果。我们通过技术评估（N=100 个视频剪辑）、用户研究（N=12）以及对电影创作者的专家访谈（N=8）对系统进行了评估。结果表明，CinemaWorld 提升了沉浸感和愉悦感，显示出其在丰富观影体验方面的潜力。
