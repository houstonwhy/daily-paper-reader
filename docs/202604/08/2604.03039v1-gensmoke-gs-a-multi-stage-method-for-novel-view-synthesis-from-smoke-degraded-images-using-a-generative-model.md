...
## 摘要
本文介绍了我们在 NTIRE 2026 3D 修复与重建（3DRR）挑战赛赛道 2（针对烟雾退化图像）中所采用的方法。在该任务中，烟雾降低了图像的能见度，并削弱了场景优化和渲染所需的跨视图一致性。我们通过一个多阶段流水线来解决这一问题，该流水线包括图像修复、去雾、基于多模态大语言模型（MLLM）的增强、3DGS-MCMC 优化以及多次运行结果的平均。该流水线的主要目的是在渲染前提高能见度，同时限制输入视图间场景内容的变化。在挑战赛基准测试上的实验结果表明，与提供的基线方法相比，我们的方法在定量性能和视觉质量上均有所提升。代码可在 https://github.com/plbbl/GenSmoke-GS 获取。根据官方竞赛网站（https://www.codabench.org/competitions/13993/#/results-tab）的报告，我们的方法在 NTIRE 3DRR 挑战赛赛道 2 的 14 名参赛者中排名第一。
